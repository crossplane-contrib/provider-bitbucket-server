# ====================================================================================
# Setup Project
PROJECT_NAME := provider-bitbucket-server
...
# TODO(jastang): update Go version to be in-line with build submodule.
...
IMAGES = provider-bitbucket-server
...
XPKGS = provider-bitbucket-server
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-bitbucket-server: do.build.images
